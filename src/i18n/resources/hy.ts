...
export const hy = {
  ...
  home: {
    promo: {
      heading: "Անվճար հայտարարությունների հարթակ",
    ...
    hits: {
      ...
      services: {
        ...
        subtitle:
          "Ամենադիտված ռեստորանները, վարպետներն ու մասնագիտական ծառայությունները"
      }
    },
    benefits: {
      verified: {
  ...
  auth: {
    ...
    forgotPassword: {
      ...
      subtitle:
        "Մուտքագրեք ձեր էլ. փոստը, և մենք կուղարկենք գաղտնաբառի վերականգնման հղում",
      emailLabel: "Էլ. փոստ",
      emailError: "Մուտքագրեք վավեր էլ. փոստ",
