...
export const hy = {
  ...
  footer: {
    ...
    publishListing: "Հրապարակել հայտարարություն",
    copyright:
      "© {{year}} {{appName}}. Ցուցադրական նախագիծ, տվյալները գեղարվեստական են։",
  ...
  home: {
    ...
    hits: {
      ...
      dailyHouses: {
        ...
        subtitle:
          "Ամբողջական առանձնատներ մեկ օրով՝ ընկերական և ընտանեկան հավաքույթների համար"
      },
      services: {
        title: "Ծառայությունների առաջարկներ",
        subtitle: "Ամենադիտված ռեստորանները, վարպետներն ու մասնագիտական ծառայությունները"
      }
    },
    benefits: {
      verified: {
  ...
  auth: {
    ...
    signUp: {
      ...
      termsLabel:
        "Համաձայն եմ Օգտագործման կանոնների և Գաղտնիության քաղաքականության հետ",
    ...
    forgotPassword: {
      ...
      subtitle: "Մուտքագրեք ձեր էլ. փոստը, և մենք կուղարկենք գաղտնաբառի վերականգնման հղում",
      emailLabel: "Էլ. փոստ",
      emailError: "Մուտքագրեք վավեր էլ. փոստ",
      submit: "Ուղարկել հղումը",
      submitting: "Ուղարկվում է...",
      backToSignIn: "Վերադառնալ մուտք գործելուն",
      sentTitle: "Հղումն ուղարկված է",
      sentDescription: "Եթե «{{email}}» հասցեով հաշիվ գոյություն ունի, կստանաք գաղտնաբառի վերականգնման հղում մի քանի րոպեի ընթացքում։",
  ...
  profile: {
    ...
    emptyListings: {
      ...
      description:
        "Տեղադրեք ձեր առաջին հայտարարությունը — դա անվճար է և տևում է մի քանի րոպե։",
      action: "Հրապարակել հայտարարություն"
    },
    emptyFavorites: {
      title: "Հավանածներում դատարկ է",
      description:
        "Պահպանեք հայտարարությունները, որպեսզի հետո համեմատեք դրանք։",
  ...
  favorites: {
    ...
    tabs: {
      all: "Բոլորը",
      realEstate: "Անշարժ գույքի վաճառք",
      cars: "Ավտոմեքենաներ",
...
export type Messages = {
  [K in keyof typeof hy]: DeepStringify<(typeof hy)[K]>;
};
