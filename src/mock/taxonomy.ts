...
export const REAL_ESTATE_SUBCATEGORIES: Option[] = [
  ...
  { value: "new-buildings", label: "Новостройки" },
...
export const CAR_BRANDS: Record<string, string[]> = {
  Toyota: ["Camry", "Corolla", "RAV4", "Land Cruiser Prado", "Highlander", "C-HR"],
...
export const CAR_BRAND_OPTIONS: Option[] = Object.keys(CAR_BRANDS).map((brand) => ({
  value: brand,
  label: brand,
}));
